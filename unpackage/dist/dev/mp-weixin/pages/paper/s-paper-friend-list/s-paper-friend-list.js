...
var _sPaperFriendList = _interopRequireDefault(__webpack_require__(/*! ./pages/paper/s-paper-friend-list/s-paper-friend-list.vue */ 81));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _s_paper_friend_list_vue_vue_type_template_id_35d365a7_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./s-paper-friend-list.vue?vue&type=template&id=35d365a7&scoped=true& */ 82);
/* harmony import */ var _s_paper_friend_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./s-paper-friend-list.vue?vue&type=script&lang=js& */ 84);
...

{
  ...
  methods: {
    ...
    getCountList: function getCountList() {var _this2 = this;
      this.request({
      ...
      then(function (res) {
        _this2.tabBars[0].num = res.data.friend_count;
        _this2.tabBars[1].num = res.data.withfollow_count;
        _this2.tabBars[2].num = res.data.withfen_count;
        _this2.getFriendList(0);
      });
    },
    getFriendList: function getFriendList(index) {var _this3 = this;
      ...
      then(function (res) {
        _this3.friendList[_this3.tabIndex].list = [].concat(_toConsumableArray(_this3.friendList[_this3.tabIndex].list), _toConsumableArray(res.data.list));
        _this3.friendList[_this3.tabIndex].currentPageNum = _this3.friendList[_this3.tabIndex].currentPageNum + 1;
      });
    } },
